...
public class Help extends Activity {
	public void onCreate(Bundle savedInstanceState) {
		...
		Button buttonBackMapHelp = (Button) findViewById(R.id.buttonBackMapHelp);
		buttonBackMapHelp.setOnClickListener(new View.OnClickListener()  { 
			public void onClick(View v) {
				startActivity(new Intent(Help.this, Map.class));               
			}
		});
